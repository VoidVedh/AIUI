export class LayoutDiffCalculator {
     ...
     */
    static compute(expectedBoxes, actualBoxes) {
        ...
        for (const act of actualBoxes) {
            ...
            if (exp.hasExplicitPosition && typeof exp.width === "number" && typeof exp.height === "number") {
                score = this.calculateBoxIou({ x: exp.x, y: exp.y, width: exp.width, height: exp.height }, act);
...
//# sourceMappingURL=layoutDiff.js.map